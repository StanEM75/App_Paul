...
st.markdown(
    """
    <div style='text-align: center; font-size: 18px;'>
        Candidate à l'offre Serveur H/F
    </div>
    """,
    unsafe_allow_html=True
)
...
with st.container():
    st.markdown(
        """
        <div style='background-color: #0445f1; padding: 20px; border-radius: 8px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);'>
            <h3 style='font-size: 24px; font-weight: bold; text-align: center;'>Serveur H/F</h3>
...
with st.container():
    st.markdown(
        """
        <div style='background-color: #df04f1; padding: 20px; border-radius: 8px; box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.1);'>
            <h3 style='font-size: 24px; font-weight: bold; text-align: center;'>Ton message de candidature</h3>
            <br>
            <br>
            <br>
            <br>
...
with st.container():
    ...
    with col1:
        st.markdown(
            """
            <div style='background-color: #727672; padding: 10px; border-radius: 8px; color: white; text-align: center; font-size: 14px;'>
                Ajouter mon CV
            </div>
            """,
            unsafe_allow_html=True
    ...
    with col2:
        st.markdown(
            """
            <div style='background-color: #0075ff; padding: 10px; border-radius: 8px; color: white; text-align: center; font-size: 14px;'>
                Joindre ma lettre de motivation
            </div>
            """,
            unsafe_allow_html=True
        )
...
# Ajouter un espace entre le texte et les blocs
st.markdown("<br>", unsafe_allow_html=True)  # Ajoute des sauts de ligne pour espacer
...
with st.container():
    ...
    with col1:
        st.markdown(
            """
            <div style='background-color: #ea8c1b; padding: 10px; border-radius: 8px; color: white; text-align: center; font-size: 14px;'>
    ...
    with col2:
        st.markdown(
            """
            <div style='background-color: #139b1b; padding: 10px; border-radius: 8px; color: white; text-align: center; font-size: 14px;'>
